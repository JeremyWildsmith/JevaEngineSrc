...
public class WorldBuilder extends DefaultGame
{
	...
	public WorldBuilder(IInputSource inputSource, ISceneModelFactory modelFactory, ISpriteFactory spriteFactory, IWindowFactory windowFactory, IParallelWorldFactory worldFactory, IFontFactory fontFactory, Vector2D resolution, String baseDirectory)
	{
		...
		try
		{
			new FloatingToolbarFactory(getWindowManager(), windowFactory, modelFactory, worldFactory, fontFactory, baseDirectory).create().center();
		} catch (AssetConstructionException e)
		{
