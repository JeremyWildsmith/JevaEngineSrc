...
public final class WorldView extends Panel
{
	...
	public void render(Graphics2D g, int x, int y, float fScale)
	{
		...
		if(m_camera != null && m_camera.getWorld() != null)
		{
			...
			world.render(g, fScale * m_camera.getScale(), new Rectangle(offset.x, offset.y, bounds.width, bounds.height), getAbsoluteLocation().x, getAbsoluteLocation().y);//bounds.width, bounds.height));
